...
// -----------------------------------------------------------------------------
BT_PROJECT g_bt_Project[1]                               =
{
   {
      .system_time.milli_second                          = 0,
      .system_time.second                                = 0,
   }
};

// -----------------------------------------------------------------------------
#define BT_TRANSMITTER_APP_ERROR_CHECK(ERR_CODE)                                                   \
   do                                                                                              \
   {                                                                                               \
      const uint32_t LOCAL_ERR_CODE = (ERR_CODE);                                                  \
      if (LOCAL_ERR_CODE != NRF_SUCCESS)                                                           \
      {                                                                                            \
         NRF_LOG_PRINTF("[%s-%d] error_code : %d \r\n", __FUNCTION__, __LINE__, (int) ERR_CODE);   \
...
void assert_nrf_callback(uint16_t line_num, const uint8_t * p_file_name)
{
   ...
   NRF_LOG_PRINTF("[%s-%d] %d, %s \r\n", __FUNCTION__, __LINE__, line_num, p_file_name);
#endif
...
static void on_adv_evt(ble_adv_evt_t ble_adv_evt)
{
   ...
   switch (ble_adv_evt)
   {
      case BLE_ADV_EVT_FAST:
         ...
         NRF_LOG_PRINTF("[%s-%d] BLE_ADV_EVT_FAST : %d \r\n", __FUNCTION__, __LINE__, BLE_ADV_EVT_FAST);
#endif
...
#if defined(DEBUG_RTT_DEBUG)
         NRF_LOG_PRINTF("[%s-%d] BLE_ADV_EVT_IDLE : %d \r\n", __FUNCTION__, __LINE__, BLE_ADV_EVT_IDLE);
#endif
         sleep_mode_enter();
         break;
      ...
      default:
#if defined(DEBUG_RTT_DEBUG)
         NRF_LOG_PRINTF("[%s-%d] default : %d \r\n", __FUNCTION__, __LINE__, ble_adv_evt);
#endif
         break;
   }
}
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
   ...
   switch (p_ble_evt->header.evt_id)
   {
...
#if defined(DEBUG_RTT_DEBUG)
         NRF_LOG_PRINTF("[%s-%d] BLE Param Update !!! : %d \r\n", __FUNCTION__, __LINE__, BLE_GAP_EVT_CONN_PARAM_UPDATE);
#endif
         break;
      ...
      case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
         ...
         BT_TRANSMITTER_APP_ERROR_CHECK(err_code);
#if defined(DEBUG_RTT_DEBUG)
         NRF_LOG_PRINTF("[%s-%d] BLE BLE_GAP_EVT_SEC_PARAMS_REQUEST !!! : %d  \r\n", __FUNCTION__, __LINE__, BLE_GAP_EVT_SEC_PARAMS_REQUEST);
#endif
         break;
      ...
      case BLE_GATTS_EVT_SYS_ATTR_MISSING:
         ...
         BT_TRANSMITTER_APP_ERROR_CHECK(err_code);
#if defined(DEBUG_RTT_DEBUG)
         NRF_LOG_PRINTF("[%s-%d] BLE_GATTS_EVT_SYS_ATTR_MISSING !!! : %d  \r\n", __FUNCTION__, __LINE__, BLE_GATTS_EVT_SYS_ATTR_MISSING);
#endif
         break;
...
#if defined(DEBUG_RTT_ERROR)
         NRF_LOG_PRINTF("[%s-%d] event : BSP_EVENT_WHITELIST_OFF \r\n", __FUNCTION__, __LINE__);
#endif
...
int main(void)
{
   ...
   memset(g_bt_Project, 0, sizeof(g_bt_Project));

   // Initialize.
   APP_TIMER_INIT(APP_TIMER_PRESCALER, APP_TIMER_OP_QUEUE_SIZE, false);
   APP_TIMER_DEF(bt_transmitter_timer);
   ...
   if (app_timer_start(bt_transmitter_timer, APP_TIMER_TICKS(1, APP_TIMER_PRESCALER), NULL) != NRF_SUCCESS)
   {
#if defined(DEBUG_RTT_ERROR)
      NRF_LOG_PRINTF("[%s-%d] Can't create app timer \r\n", __FUNCTION__, __LINE__);
#endif
   ...
   NRF_LOG_PRINTF("Build : compiled %s %s  \r\n", __DATE__, __TIME__);
   NRF_LOG_PRINTF("=============================================================  \r\n");
